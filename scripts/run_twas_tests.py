...
{{
	...
	"eqtl_experiments":	
	{{
            "{1}/hg19/eqtl/eqtl_sumstats{0}.txt.gz": {{"ref": "{1}/hg19/eqtl/eqtl_genotypes{0}.vcf.gz", "phenos": "{1}/hg19/eqtl/eqtl_phenotypes{0}.bed.gz"}}
	}},
...
for i in range(num_tests):
    ...
    # Get it going
    subprocess.call("python /users/mgloud/projects/brain_gwas/scripts/dispatch.py /users/mgloud/projects/coloc_comparisons/tmp/twas.config 8", shell=True)
